...
class MOELoraConfig(LoraConfig):
    """
    This is the configuration class to store the configuration of a [`~peft.MOE_LORA`]
    """
...
class MOELoraModel(LoraModel):
    ...
    def _create_new_module(self, lora_config, adapter_name, target):
        ...
        if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
            ...
            new_module = MOELoraLinear(adapter_name, in_features, out_features, bias=bias, **kwargs)
