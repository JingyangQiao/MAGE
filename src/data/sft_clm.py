...
def decode_gen_data(item,
    ...
    instruction = value["data"][0] + " " + value["data"][1]
    ...
    instruction = instruction_prompt.format_map({'instruction': instruction})
...
def build_gen_jsonl_datapipes(data_dir,
                              image_dir,
                              tokenizer=None,
                              max_length=77,
                              batch_size=None,
    ...
    decode_partial = functools.partial(decode_gen_data,
                                       image_dir=image_dir,
                                       tokenizer=tokenizer,
                                       image_transform=image_transform,
                                       max_length=max_length,
